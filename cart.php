      ...
      ?>    
        <table>
          ...
          <?php echo "$no";  ?>
			...
			?>
              <span class="currency">Rp.</span><span class="value"><? echo "$hargadisc"; ?></span>
            
            </td>
            <td class="price dark">
            
              <span class="currency">Rp.</span><span class="value"><? echo "$subtotal_rp"; ?></span>
            
            </td>
            <td class="price"><? echo"<a href='aksi.php?module=keranjang&act=hapus&id=$r[id_orders_temp]'>Hapus</a>"; ?></td>
          </tr>
        <?php
		$no++;
		  }
            ...
            <td colspan="3" class="total-wrapper">
              ...
              <div class="total clearfix">
                ...
                <div class="half-col value-wrapper">
                  ...
                  <span class="currency">Rp.&nbsp;</span><span class="value"><? echo "$total_rp"; ?></span>
