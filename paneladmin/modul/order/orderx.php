                      ...
                      <table cellpadding='0' cellspacing='0' width='100%' class='table' id='tSortable'>
                            <thead>
                                <tr>
                                    ...
                                    <th width='23%'>Status Order</th>
									<th width='23%'>Id Kustomer</th>
                                    <th width='23%'>Aksi</th>                                   
                                </tr>
                            </thead>
                            <tbody>";
							
 							$tp=mysql_query("SELECT * FROM orders ORDER BY id_orders ASC");
...
echo "<tr><td colspan=3 align=right>Total : </td><td>Rp. <b>$total_rp</b></td></tr>
  ...
  case "kirimemail":
    mail($_POST[email],$_POST[subjek],$_POST[pesan],"From: cujonline@gmail.com");
