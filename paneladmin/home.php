            ...
            <div class="row-fluid">
              		...
              		<h3>Produk Terbaru</h3>
                        <div>
                            <table cellpadding="0" cellspacing="0" width="100%" class="sOrders">
                                ...
                                <tbody>
                                <?php
								$tampilproduk=mysql_query("select * from produk order by id_produk DESC limit 4");
                        ...
                        <div>
                            <table cellpadding="0" cellspacing="0" width="100%" class="sOrders">
                                <thead>
                                    <tr>
                                        <th width="60">Tanggal</th><th>Nama Kustomer</th><th width="55">Status</th><th width="5">ID</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <?php
                                $tampilorder=mysql_query("select * from orders order by id_orders DESC limit 4");
                                while($order=mysql_fetch_array($tampilorder))
								{
                              echo "<tr>
                                        <td><span class='date'>$order[tgl_order]</span><span class='time'>$order[jam_order]</span></td>";
									
								   $tampilkustomer=mysql_query("select * from kustomer order by id_kustomer='$order[id_kustomer]' DESC limit 4");	
								   ...
								   echo"<td><span class='price'>$order[id_orders]</span></td>";
                                  echo"</tr>";
								}
								?>
                                <tfoot>
                        ...
                        <div>
                            <table cellpadding="0" cellspacing="0" width="100%" class="sOrders">
                                ...
                                <tbody>
                                <?php
								$tampilkota=mysql_query("select * from kota limit 9");
                ...
                <div class="span4">
                    ...
                    <div class="block news scrollBox">
                        ...
                        <div class="scroll" style="height: 333px;">
                          <?php 
						  $tampilsekilas=mysql_query("select * from sekilasinfo order by tgl_posting DESC");
                       ...
                       echo"<div class='item'>
                                ...
                                <div class='controls'>                 
									...
									<a href='?p=sekilasinfo&aksi=edit&id=$r[id_sekilas]'>Edit</a>        
                ...
                <div class="span4">
                    ...
                    <div class="block users scrollBox">
                        ...
                        <div class="scroll" style="height: 333px;">
                     <?php 
					 $tampilcus=mysql_query("select * from kustomer order by id_kustomer DESC");
					 while($customer=mysql_fetch_array($tampilcus))
					 {	   
                     echo"<div class='item clearfix'>
                                <div class='image'><a href='#'><img src='img/users/aqvatarius_s.jpg' width='32'/></a></div>
                                <div class='info'>
                                    <a href='#' class='name'>$customer[nama_lengkap] </p> $customer[email]</a>                                                                    
                                    <div class='controls'>"; 
								   if ($customer[aktif]=="Y")
								   {                                   
            ...
            <div class="row-fluid">
                ...
                <div class="span6">
                    ...
                    <div class="block messaging">
                      ...
                      <?php
				   $tampilpesan=mysql_query("select * from komentar order by tgl DESC limit 6");
