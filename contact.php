...
<body>
      ...
      <div role="main" class="container contact">        
        ...
        <div class="row top-spacing">
	     ...
	     CUJ-ONLINE : sebuah perusahaan yang bergerak dalam bidang Entertainment, Supply, Website, Networking, Maintenance dan Rental	
          ...
          <div class="span6 offset1">
            ...
            <p>
              Komp Areman Baru No. 35 Tugu Cimanggis Depok 14651.
            </p>
            
            <ul class="rr info clearfix">
              <li>
                Phone: <span class="val">0856 945 90 845</span>
              </li>
               <li>
                Email: <span class="val">cujonline@gmail.com</span>
              </li>
              <li>
                Fax: <span class="val"></span>
              </li>             
              <li>
                Web: <span class="val">www.cuj.co.id</span>
              </li>
            </ul>
