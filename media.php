...
<!--[if gt IE 99]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
      ...
      <title>..:: CUJ - ONLINE ::..</title>
      <meta name="author" content="Satriyo Utomo">
        ...
        <div class="row">
          ...
          <div class="span3 logo-wrapper">
            <a href="?hal=home" class="logo">
              <span class="icon ir">CUJONLINE</span>
              <h1>CUJ - ONLINE</h1>
            </a>
          </div>
          ...
          <div class="span5 collections">
            ...
            <div>
              <ul class="content rr">
                <li class="current"><a href="">Koleksi Hijab Terbaru Tahun 2014</a></li>
              ...
              <span class="icon ir">Cart</span>
               <?php
				...
				$sql = mysql_query("SELECT SUM(jumlah*harga) as total,SUM(jumlah) as totaljumlah FROM orders_temp, produk 
				    ...
				    echo "<span class='text'><a href='?hal=cart'><span class='title'>Keranjang Belanja</span></a> (<span>$r[totaljumlah]</span> items) - </span>
					  <span class='price'><span>Rp.</span><span>$total_rp</span></span>";
					}
					else
					{
					echo "<span class='text'><a href='?hal=cart'><span class='title'>Keranjang Belanja</span></a> (<span>0</span> items) - </span>
        ...
        <div class="row main-menu-wrapper">
          ...
          <div class="span9">
            ...
            echo"<li class='span2 beta'>
              ...
              <li><a href="?hal=cart">Keranjang Belanja</a></li>
                ...
                <ul class="connect rr">
                  ...
                  <li>
                    <a href="#" class="clearfix">
                      ...
                      <span class="phone-no">0856 945 90 845</span>
                    </a>
                  </li>
                  <li>
                    <a href="#" class="clearfix">
                      <span class="ir icon mail">Mail</span>
                      <span>cujonline@gmail.com</span>
                    </a>
                  </li>
                </ul>
              </div>
